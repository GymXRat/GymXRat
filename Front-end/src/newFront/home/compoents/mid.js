...
function Mid(){
    ...
    return(
        ...
        <div id="fitway-page-text-after-explore"><h5>GymXRat ia a environment which helps to achieve goals with varieties of</h5>  <h3><b class="h1maintitlecolor"> PROGRAMS</b></h3> </div>
